...
public class InsultGenerator {
	public String generateInsult() {
		String words[][] = {{"Desgraciado", "Inútil", "Iconoclasta"}, {"Base-court", "Bat-fowling", "Beef-witted"}, {"Apple-john", "Baggage", "Barnacle"}};
		String vowels = "AEIOU";
		String article = "an";
		...
		return String.format("Eres un %s %s %s %s!", article, firstAdjective, secondAdjective, noun);
	}
